...
/**
 * Example showing how to upload a file using a `Curl` instance
 * The upload is going to be the same than one done using a form with POST and a multipart/form-data
 */
...
const imageFilename = path.resolve(__dirname, 'upload.png')
